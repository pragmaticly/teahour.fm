...
f+'.instances[\'$1\']&datetime=$3" width="1" height="1" allowscriptaccess="always">       </object>';m=i+"player-graphics.gif?1546433651";k=i+"player-graphics@2x.gif?1546433651";i+="audiojs.swf";j=document.createElement("audio");j=!(j.canPlayType&&j.canPlayType("audio/mpeg;").replace(/no/,""));g[f]={instanceCount:0,instances:{},flashSource:l,settings:{autoplay:!1,loop:!1,preload:!0,imageLocation:m,retinaImageLocation:k,swfLocation:i,useFlash:j,hasFlash:function(){if(navigator.plugins&&navigator.plugins.length&&navigator.plugins["Shockwave Flash"])return!0;
